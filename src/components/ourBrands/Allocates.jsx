...
const Allocates = () => {
  ...
  const logos = (item, index) => (
    <div
      key={index}
      className=' justify-content-center align-items-center mb-md-4 col-6 col-md-6 col-lg-4'
    >
      <div className='text-center px-sm-4 px-md-0 my-4 col-12 col-sm-5 col-md-8'>
  ...
  return (
    <div className='row mx-0'>
      <div className='d-md-none col-12 text-center pt-5 px-5'>
      ...
      <div className='d-none d-md-block col-6 text-center pt-5 px-5'>
        <h2 className='fw-bold text-primary mb-4'>Marcas que distribuimos</h2>
        <p className='text-justify lead'>
          "Sed ut perspiciatis unde omnis iste natus error sit voluptatem
          accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae
